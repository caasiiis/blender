...
from bl_ui.utils import COMPAT_ENGINES_ALL, COMPAT_ENGINES_EEVEE_WORKBENCH, DataButtonsPanelBase, PresetPanel
from bl_ui.space_properties import PropertiesAnimationMixin


class CameraButtonsPanel(DataButtonsPanelBase):
